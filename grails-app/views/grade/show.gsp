...
<html>
    ...
    <body>
        ...
        <div id="show-grade" class="content scaffold-show" role="main">
            ...
            <f:display bean="grade" />
            <g:form resource="${this.grade}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.grade}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
